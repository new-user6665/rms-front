          ...
          selectedCategoryForTotal?.teams?.map((team,index)=>{
           ...
           let  OGTeam = props.teams.find((tm , i)=>{
            ...
            <div className="h-full w-1/2 px-2 font-bold leading-tight pt-3 text-white">
              ...
              <h1 className="text-3xl 2xl:text-5xl">{team.grandArtsResult}</h1>
              <div style={{background:`${OGTeam?.color}`}} className="w-28 h-5 rounded-xl flex items-center justify-center">
            ...
            <div className="h-full w-1/2 flex flex-col items-start justify-start pt-5 px-3">
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-white">Arts : {team.grandArtsResult}</p>
              </div>
              <div className="flex items-center gap-2">
                <span className="h-[5px] w-[5px] bg-blue-400 rounded-full" />
                <p className="text-xs text-white">Sports : {team.grandSportsResult}</p>
              </div>
            </div>
          </div>)
          })
