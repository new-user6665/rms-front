...
export default async function page({ params }: { params: { chestNo: string }  }) {
    ...
    return <main className="bg-background w-screen h-screen">
  ...
  <div className="flex flex-col w-full h-screen bg-[#0E0123] xl:hidden">
    ...
    <div className="w-full bg-white rounded-t-[3rem] h-full overflow-hidden">
      ...
      <div className="flex justify-center gap-1 mt-2">
        <button className="w-auto bg-[#3D127A] text-white text-xs bigphone:text-base font-semibold rounded-3xl px-3">
          All
        </button>
        <button className="w-auto bg-white border border-[#3D127A] text-[#3D127A] text-xs bigphone:text-base font-semibold rounded-3xl px-3">
          Chronicle
        </button>
        <button className="w-auto bg-white border border-[#3D127A] text-[#3D127A] text-xs bigphone:text-base font-semibold rounded-3xl px-3">
          Tribune
